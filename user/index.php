...
<body>
		...
		<!--	<div class="col-md-6 donate-f-login">
			 ...
			 <!-- Modal Login -->
						...
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" name="passwor" id="password" placeholder="Enter password">
						</div>
						<div class="checkbox">
						  <label><input type="checkbox" value="" checked>Remember me</label>
						</div>
						  <button type="submit" class="btn btn-success btn-block" style="align:center;font-size:17px;"><span class="glyphicon glyphicon-on"></span> Login</button>
						</form>
						</div>
				  </div>
  ...
  <!--Modal Register-->
						...
						<div class="form-group">
							...
							<input type="text" name="firstname" class="form-control" id="firstname" style="width: 100%;padding:5px; margin:0 10px 10px 0;float:left"required placeholder="First Name"/>
							
							<input type="text" name="lastname" class="form-control" id="lastname" style="width: 100%; padding:5px;margin: 0 10px 10px 0;" placeholder="Last Name"/>
						 <!-- <label for="usrname"><span class="glyphicon glyphicon-user"></span> Name</label>
						  <input type="text" class="form-control" name="email" id="email" placeholder="Enter email">-->
						
						  	<input type="email" name="email" class="form-control" id="email" style="width: 100%;padding:5px; margin:0 10px 10px 0;float:left"required placeholder="Email"/>
							...
							<input type="text" name="Batch" class="form-control" id="Batch" style="width: 100%; padding:5px;margin: 0 10px 10px 0;" required placeholder="Batch"/>
							...
							<input type="text" name="roll" class="form-control" id="roll" style="width: 100%; padding:5px;margin: 0 10px 10px 0;" required placeholder="Mobile Number"/>
							</label>
						
						  	<input type="tel" name="mobile1" class="form-control" id="mobile1" style="width: 100%; padding:5px;margin: 0 10px 10px 0;" required placeholder="WhatsApp Number"/>
							
							<input type="tel" name="mobile2" class="form-control" id="mobile2" style="width: 100%; padding:5px;margin: 0 10px 10px 0;" required placeholder="Alternative Number"/>
						
						
						
						  	<input type="password" name="password" class="form-control" id="password" style="width: 100%;padding:5px; margin:0 10px 10px 0;float:left" required placeholder="Password"/>
						...
						<div class="checkbox">
						  ...
						  <button type="submit" class="btn btn-success btn-block" style="align:center;font-size:17px;"><span class="glyphicon glyphicon-on"></span> Register</button>
						</form>
						</div>
				  </div>
